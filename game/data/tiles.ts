...
export const TILE_DECK: TileTemplate[] = [
  ...
  // PURPLE - Quest Tiles
  {
    ...
    quest: {
      ...
      description: "Spend money on 5 actions. Reward: 5 Reputation + 5 VP",
      triggerType: "spend_money",
      maxProgress: 5,
      reward: { reputation: 5, vpFlat: 5 },
    },
  },
  {
    id: "quest-materials",
    ...
    quest: {
      ...
      description: "Spend materials on 4 actions. Reward: 8 Reputation + 3 VP",
      triggerType: "spend_materials",
      maxProgress: 4,
      reward: { reputation: 8, vpFlat: 3 },
    },
  },
  {
    id: "quest-reputation",
  ...
  },
  {
    ...
    quest: {
      ...
      description: "Spend money on 4 actions. Reward: 7 Reputation + 6 VP",
      triggerType: "spend_money",
      maxProgress: 4,
      reward: { reputation: 7, vpFlat: 6 },
    },
  },
];
